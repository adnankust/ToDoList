    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageButton.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                EditText editText = viewInput.findViewById(R.id.noteTitle);
                EditText editDescription = viewInput.findViewById(R.id.noteDescription);

                new AlertDialog.Builder(MainActivity.this).setView(viewInput)
                        .setTitle("Add a Note")
                        .setPositiveButton("Add", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialogInterface, int i) {
                                ...
                                if(isInserted) {
                                    ...
                                    Toast.makeText(MainActivity.this, "Unable to add note", Toast.LENGTH_SHORT).show();
                                }
